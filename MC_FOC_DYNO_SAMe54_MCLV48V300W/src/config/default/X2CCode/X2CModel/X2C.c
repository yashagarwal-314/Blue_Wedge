...
void X2C_Init(void)
{
    ...
    /* Block: Dyno/ConstT5                                                                                            */
    /* Value = 0.01                                                                                                   */
    x2cModel.blocks.sDyno.bConstT5.K = 328;

    /* Block: Dyno/ConstT6                                                                                            */
    /* Value = 0.005                                                                                                  */
    x2cModel.blocks.sDyno.bConstT6.K = 164;

    /* Block: Dyno/ConstT7                                                                                            */
    /* Value = 0.005                                                                                                  */
    x2cModel.blocks.sDyno.bConstT7.K = 164;
    ...
    /* Phase = 0.0                                                                                                    */
    /* ts_fact = 10.0                                                                                                 */
    x2cModel.blocks.sDyno.bSin_load.delta_phi = 1311;
    x2cModel.blocks.sDyno.bSin_load.phase = 0;
    x2cModel.blocks.sDyno.bSin_load.offset = 819;
    x2cModel.blocks.sDyno.bSin_load.phi = 0;

    /* Block: Dyno/const_torque                                                                                       */
    /* Value = 0.005                                                                                                  */
    x2cModel.blocks.sDyno.bconst_torque.K = 164;

    /* Block: Dyno/fan_gain                                                                                           */
    /* Gain = 0.001                                                                                                   */
    x2cModel.blocks.sDyno.bfan_gain.V = 33;
    x2cModel.blocks.sDyno.bfan_gain.sfr = 15;
    ...
    /* Value = 0.05                                                                                                   */
    x2cModel.blocks.sDyno.bt_load_high.K = 1638;

    /* Block: Dyno/t_load_low                                                                                         */
    /* Value = 0.01                                                                                                   */
    x2cModel.blocks.sDyno.bt_load_low.K = 328;
